...
ALTER TABLE public.usuario ADD COLUMN foto_perfil varchar(300);

ALTER TABLE produto ALTER COLUMN imagem_produto TYPE text;
    ALTER TABLE categoria ALTER COLUMN imagem TYPE text;
